...
Raw syscalls without C library safety net.
...
This one is cross-compiled from a Linux container, because life is too short to write assembly on Windows.
...
This build is native, just you and your terminal.
